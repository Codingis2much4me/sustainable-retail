...
def run_strategic_prediction(products, target_month, target_year):
    ...
    for product in products:
        data_to_predict.append({
            ...
            "local_event": 0, # Assume no local event for base prediction
...
def run_tactical_analysis(df_inventory):
    ...
    df_inventory['recovered_revenue'] = df_inventory['current_stock'] * df_inventory['price'] * df_inventory['discount_rate']
